...
public class LocalUserController {
    ...
    public ResponseEntity<Response> like(@CookieValue("X-AUTH-TOKEN") String token, @RequestBody LikeDto dto) {
        Long userId = tokenProvider.getUserId(token);
        userService.like(userId, dto.getTargetId(), dto.getLikeType());
    ...
    public ResponseEntity<Response> unlike(@CookieValue("X-AUTH-TOKEN") String token, @RequestBody LikeDto dto) {
        Long userId = tokenProvider.getUserId(token);
        userService.unlike(userId, dto.getTargetId(), dto.getLikeType());
    ...
    public ResponseEntity<Response> report(@CookieValue("X-AUTH-TOKEN") String token, @RequestBody ReportDto dto) {
        Long userId = tokenProvider.getUserId(token);
        userService.report(userId, dto.getTargetId(), dto.getReportType());
    ...
    public ResultDto<List<UserDto>> findUsersStartWithNickname(@RequestBody UserNicknameDto dto) {
        return userService.findUsersStartWithNickname(dto.getNickname());
    }
}
